...
class InterestsCollectionWidget<T> extends StatefulWidget {
  ...
  @override
  State<InterestsCollectionWidget<T>> createState() => _InterestsCollectionWidgetState<T>();
}

final Set<int> selectedInterests = {};

class _InterestsCollectionWidgetState<T> extends State<InterestsCollectionWidget<T>> {
  @override
          ...
          return GestureDetector(
              onTap: () {
                setState(() {
                  ...
                  if (isSelected) {
                    ...
                    widget.removeInterest(provider, widget.interestsList[selectedInterestIndex]);
                  } else {
                    selectedInterests.add(selectedInterestIndex);
                    widget.addInterest(provider, widget.interestsList[selectedInterestIndex]);
                  }
                });
              },
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? AppColors.kFernGreen.withOpacity(.90) : AppColors.kDarkGreen.withOpacity(.90),
                  borderRadius: BorderRadius.circular(100.0),
                  border: Border.all(color: isSelected ? AppColors.kFernGreen : AppColors.kDarkGreen, width: 3),
                ),
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      color: isSelected ? Colors.black : Colors.white, fontSize: 16, fontWeight: FontWeight.w400),
                ),
              ));
        })
      ],
